...
// ====================================================================
// Array Size Limits for Bounds Checking
// ====================================================================
// These constants define the maximum dimensions for fixed-size arrays
// to prevent memory corruption. Runtime validation should ensure that
// configuration parameters (BS_M, BS_N, etc.) do not exceed these limits.
// ====================================================================
const int MAX_SECTORS = 3;           // Maximum number of sectors per BS
const int MAX_BS_M = 32;             // Maximum M dimension for BS antenna
const int MAX_BS_N = 64;             // Maximum N dimension for BS antenna
const int MAX_BS_P = 2;              // Maximum P (polarization) dimension
...
const int MAX_RSRP_PANEL = 2;        // Maximum number of panels
