...
// ============================================================================
// Set to 1 to enable OpenMP multithreading, 0 to disable (single-threaded mode)
// When disabled, all OpenMP parallel regions will run sequentially on a single thread
